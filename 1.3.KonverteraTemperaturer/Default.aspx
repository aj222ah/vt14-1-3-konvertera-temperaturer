    ...
    <body>
        <form id="TempConversion" runat="server">
            ...
            <div id="inputField">
                ...
                <asp:RangeValidator ID="StepSizeInRange" runat="server" ErrorMessage="Du måste ange ett temperatursteg som är mellan 1 och 100." MinimumValue="1" MaximumValue="100" Display="Dynamic" ControlToValidate="StepSize" CssClass="error"></asp:RangeValidator>
                
                <%-- Radiobuttons för omräkningstyp. --%>
                <br /><asp:Label ID="ConversionType" runat="server" Text="Typ av konvertering:"></asp:Label><br />
                <asp:RadioButton ID="CtoF" runat="server" Text="Celsius till Fahrenheit" Checked="True" GroupName="ConversionType" /><br />
